...
class convert_orthomosaic_to_list_of_tiles:
    ...
    def get_processing_tiles(self, tile_size):
        """
        Return a list of tiles with padding.
        ...
        all directions.
        """
        processing_tiles, st_width, st_height = self.define_tiles(0, tile_size, tile_size)
    ...
    def define_tiles(self, overlap, height, width):
        """
        Return a list of tiles from a orthomosaic.
        ...
        for r in range(0, n_height):
            for c in range(0, n_width):
                ...
                if c == (n_width - 1):
                    ...
                    tile_c = c * step_width
                tiles.append(
                    Tile((tile_r, tile_c), pos, height, width, resolution, crs, left, top, self.filename_orthomosaic)
                )
